...
const HOROSCOPE_DATA = [
  {
    ...
    horoscope: "Trust your instincts today and take decisive action—you’re capable of handling the consequences. Key business decisions may need to be made, and financial support from someone close could help. Be mindful of your behavior with children and loved ones, as impatience can create distance. Your partner may find your unpredictability difficult, so give space where needed. Workplace rivals may face setbacks of their own. Several matters demand immediate attention, making it essential to balance personal and marital boundaries.\n\nDirect your energy toward meaningful goals and productive collaborations. Avoid crossing the line between guidance and control. Pacing yourself will prevent burnout—sometimes restraint is just as powerful as action.",
...

  {
    ...
    horoscope: "Staying calm will help you manage the day smoothly. Unexpected expenses may strain finances, but your partner remains supportive despite mood swings. Romance stays lively, though diplomacy is needed at work. Someone close may seek your time, but commitments could prevent you from meeting expectations, causing mild disappointment. Family disagreements may spill into your married life.\n\nYou may feel restricted by circumstances, but emotional balance is within reach. Seeking mediation can resolve lingering conflicts. Exploring unconventional solutions may restore your sense of independence.",
...

  {
    ...
    horoscope: "Enjoyment and relaxation are highlighted today. Saving money proves wise, as it may help you navigate future challenges. Children may test your patience, so respond with affection rather than stress. Emotional contradictions in love could surface, and unresolved issues with your spouse may cause tension. Avoid signing new partnerships. Personal time helps restore balance.\n\nA structured approach works best, but don’t isolate yourself. Collaboration boosts efficiency—reach out even if it feels unfamiliar.",
...

  {
    ...
    horoscope: "A hopeful and optimistic mood surrounds you. Avoid risky financial habits like gambling. Shopping or spending time with your spouse strengthens emotional bonds. Love brings reassurance, while adopting new work techniques boosts productivity. Free time with friends feels refreshing. Nostalgic moments with your partner rekindle youthful joy.\n\nYour emotional clarity is strong today. Use this momentum to finalize plans and secure commitments you’ve been considering.",
...

  {
    ...
    horoscope: "You’ll find time to focus on your health and appearance today. Avoid lending money casually. Seek elders’ advice before making household changes. Romance feels exciting and fulfilling. Creative work brings satisfaction, while events and seminars expand your network. A pleasant surprise with your spouse lifts your mood.\n\nMental focus is strong, but emotions may lag behind. Let things unfold naturally rather than forcing outcomes—timing works in your favor.",
...

  {
    ...
    horoscope: "Spending time on hobbies lifts your mood. Financial stability improves, allowing you to clear debts. Domestic tension may arise due to overreactions around money. Love reaches a new emotional depth. Professional networking abroad looks promising. You’ll manage to carve out personal time, though relationship disagreements may be difficult to resolve.\n\nCommunication is key today. Your words carry influence—use them wisely. Moving between tasks may actually increase productivity.",
...

  {
    ...
    horoscope: "Mind your diet today to avoid health issues. Financial gains through overseas business look favorable. Social events connect you with influential people. Love feels deeply fulfilling. Career advancements, especially in banking, are possible. Travel proves refreshing, and marital warmth returns.\n\nEmotional restraint helps maintain balance. Stay flexible and avoid overanalyzing situations—ease brings clarity.",
...

  {
    ...
    horoscope: "A feel-good day encourages self-care. Financial issues ease with help from friends. Domestic situations may be unpredictable—maintain discretion in love matters. Work steadily without revealing plans prematurely. Leisure time may feel unfulfilling, but your partner’s thoughtful gesture restores warmth.\n\nYour mood remains upbeat and adaptable. Emotional discipline helps you thrive in rigid environments—social interaction works in your favor.",
...

  {
    ...
    horoscope: "A cheerful and productive day lies ahead. Investments in valuables may pay off. Emotional unpredictability from someone close requires patience. Romantic trips create lasting memories. You receive fulfilling work assignments and appreciation for your opinions. Married life feels especially rewarding.\n\nEmotional restlessness may arise, but positivity helps you regain momentum. Honest conversations offer valuable insights.",
...

  {
    ...
    horoscope: "Self-doubt may slow progress, so trust your abilities. Income from commissions or royalties looks promising. Friends offer timely support. Your charm attracts attention, and professional learning gives you an edge. Family time becomes a priority. You recognize your true value in your partner’s eyes.\n\nMind your words—emotional reactions may be misinterpreted. Discipline and positivity help you maintain control and direction.",
...

  {
    ...
    horoscope: "Harsh behavior may strain your relationship—awareness is key. Financial inflows ease immediate concerns. Stay cautious in dealings with friends or associates. Professional events strengthen business connections. Despite social overload, you manage to secure personal time. Domestic responsibilities may cause stress in marriage.\n\nConfusion may cloud judgment, but discipline anchors you. Stay aligned with your principles—support is available if you ask.",
...

  {
    ...
    horoscope: "Spiritual support brings inner peace. Income flows from multiple sources, though concerns about your partner’s health may arise. Romance feels subdued, but teamwork is essential—handling everything alone won’t work today. Family obligations consume time, making personal space necessary in marriage.\n\nClear communication prevents misunderstandings. Step forward with confidence—your role connects people and ideas in meaningful ways.",
