...
const HOROSCOPE_DATA = [
  {
    ...
    horoscope: "Your mood lifts as positive energy surrounds you. Financial discipline is essential—avoid risky schemes and unnecessary expenses. Don’t let others manage your money today. Confidence works in your favor, especially in relationships. Avoid partnerships that lack clarity. You’ll enjoy personal time for relaxation or hobbies. Married life feels supportive and affectionate.\n\nRecognition finally arrives after recent challenges. Criticism fades, replaced by appreciation. Accept praise confidently—you’ve earned this phase of calm success.",
...

  {
    ...
    horoscope: "Mind–body balance improves through meditation or quiet reflection. Stay alert with money matters, especially lending. Distance yourself from negative influences. Miscommunication may cause mild stress, so be clear. Work pressure increases, but social connection helps restore balance. Marriage may feel demanding today.\n\nYou’re entering a phase of reassessment. Focus less on the past and more on future goals. Identity and direction are evolving—move patiently through this transition.",
...

  {
    ...
    horoscope: "A satisfying day boosts your confidence. Avoid property-related investments today. Social gatherings bring joy, and creativity is high. New plans move forward smoothly. Reconnecting with old friends helps you unwind. Married life feels especially fulfilling.\n\nListen to your body. Persistent aches need attention. Taking a short pause from routine responsibilities will restore balance.",
...

  {
    ...
    horoscope: "Health stays steady despite responsibilities. Financial ease helps clear dues. Visiting family brings emotional comfort. Open conversations strengthen love bonds. Partnerships and travel favor long-term gains. Married life feels peaceful.\n\nReflect deeply on your life choices. Ensure your career path truly aligns with your inner purpose and talents.",
...

  {
    ...
    horoscope: "Kindness brings happiness today. Unexpected financial gains may arrive. Family duties increase, but romance blossoms as friendships deepen. Career performance is strong, though balancing family time remains challenging. Married life feels affectionate.\n\nMeditation helps manage impatience. Focus only on what truly matters and avoid starting unnecessary projects.",
...

  {
    ...
    horoscope: "Recovery from minor health issues boosts confidence. Control anger at work to avoid setbacks. Social visits occupy your time. Stay alert during important conversations—you may gain valuable insight. Take time for self-reflection. Romance feels warm, though minor health concerns may arise.\n\nStay grounded. Today’s actions lay the foundation for future stability—patience and consistency are key.",
...

  {
    ...
    horoscope: "A positive day boosts self-worth. Unexpected money brings relief. Home improvements go well. Romance needs sensitivity—avoid offending your partner. Work projects near completion. Solitude in the evening helps clarity. Spouse later reveals thoughtful efforts.\n\nYou’re nearing the end of a long personal transformation. Relax and enjoy the progress—you deserve a pause.",
...

  {
    ...
    horoscope: "Positive thinking strengthens resilience. Avoid lending money today. Resolve domestic conflicts calmly. Romance flows smoothly, and professional gains come from timely execution. Personal time with your partner feels deeply satisfying.\n\nHonor your need for solitude today. Stepping back emotionally brings clarity and renewed strength.",
...

  {
    ...
    horoscope: "Minor health stress may surface, but finances stay stable. Social celebrations lift your spirits. Communicate important feelings today—delay may cause regret. New income ideas appear. An unexpected guest disrupts plans, but married life feels loving.\n\nFriendships prove their true value today. Accept support—you don’t have to do everything alone.",
...

  {
    ...
    horoscope: "Diet discipline improves well-being. Finances stabilize, though expenses remain. Family visits bring joy. Romance feels promising. Workplace conversations finally move forward. Domestic gatherings consume time, but married life feels fulfilling.\n\nYou’ve moved past recent difficulties. Enjoy this calm phase—it prepares you for an upcoming period requiring full focus.",
...

  {
    ...
    horoscope: "Confidence attracts positive attention today. Avoid overspending to impress others. Romance thrives through thoughtful surprises. Stay alert at work—competition is active. Self-improvement efforts pay off, though relationship tension may arise.\n\nA desire for change grows stronger. Consider new surroundings or short travel—it refreshes your spirit.",
...

  {
    ...
    horoscope: "Let go of jealousy—it drains your peace. Financial gains come independently. Sharing worries with loved ones brings relief. Romance feels magical, and work efforts are recognized. Though personal time is limited, married life feels joyful.\n\nStep back and observe rather than react. This reflective distance brings clarity and emotional strength.",
