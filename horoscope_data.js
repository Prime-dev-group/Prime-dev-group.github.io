...
const HOROSCOPE_DATA = [
    {
        ...
        horoscope: "Rest is crucial today, as recent mental pressure may have taken a toll; prioritizing recreation will help you unwind. Avoid new investments without advice, but do reach out to old contacts. Romantic surprises are possible, though work stress could test your patience—lean on close friends and your spouse for support. Deep personal changes may be stirring nervousness, so be mindful not to project frustrations onto loved ones; instead, look inward for answers.",
    ...
    },
    {
        ...
        horoscope: "Sharing joy effectively boosts your health today, while financial prudence becomes clear—though you might still splurge on household items or jewelry. Romance and creativity are highlighted, bringing unexpected appreciation. You may crave solitude to process complex thoughts, yet your partner's support will be unwavering. Surprising new interests could emerge, prompting you to explore unconventional hobbies and embrace a newfound sense of adventure.",
    ...
    },
    {
        ...
        horoscope: "Engaging in sports will help maintain your stamina, and despite financial hurdles, evening profits are likely. Take a break to socialize and experience deep affection. Hard work will bring you closer to your goals, and while travel may be costly, it will prove rewarding. Your spouse’s efforts will bring happiness. Trust your own path today; true treasures are found by following your unique calling rather than conventional advice.",
    ...
    },
    {
        ...
        horoscope: "Enjoy a recreational day and seek financial wisdom from elders to improve your savings. Dedicate free time to family, though be mindful of your partner’s sensitivities. Honesty and determination will boost your professional standing, while travel or study expands your horizons. A peaceful evening awaits. You're in a visionary mood, eager for modern approaches over old traditions; embrace this innovation but be careful not to spark unnecessary conflict.",
    ...
    },
    {
        ...
        horoscope: "Relaxing with friends is recommended today. You may realize the value of financial planning as a need arises. Parental health might cause worry, while a sudden romantic encounter could leave you bewildered. Work projects are nearing completion, but steer clear of gossip to stay productive. Your partner's love offers comfort. It's a powerful time to conquer personal fears and guilt; this internal 'housecleaning' will positively impact your career as you finally recognize your true worth.",
    ...
    },
    {
        ...
        horoscope: "Past choices might cause frustration today; don't hesitate to seek advice if you feel stuck. Conversely, energy is high with unexpected gains and social visits likely. Express your feelings to your partner promptly to avoid regrets. It's a great day for launching new projects, as luck is on your side. However, avoid taking your relationship for granted to prevent conflicts. Trust your strong intuition, but balance your impulsive spirit with necessary caution.",
    ...
    },
    {
        ...
        horoscope: "Prioritize your health, especially if prone to blood pressure issues, and be cautious with debt repayments. Emotional control may be difficult; avoid nagging to prevent isolation. Your love life shines, but discretion is advised at work to protect your image. Business ventures require caution, yet your communication skills remain a strong asset. Even if the world feels chaotic, your partner provides a sanctuary. Focus on understanding others; it's a prime time to pitch ideas and potentially meet someone dynamic who opens new doors.",
    ...
    },
    {
        ...
        horoscope: "A smile is your best remedy today. Financial realities may hit home, urging better management. While your spouse's health could cause stress, your love life remains a beacon of hope. Embracing new skills is key for career growth, as is networking with influential figures. You'll appreciate the joy of your marriage. Expect an intense emotional encounter; minor issues might spark cathartic arguments, signaling a desire for deeper, more authentic connections in your relationships.",
    ...
    },
    {
        ...
        horoscope: "Controlling emotions might be tough, potentially enticing confusion around you, but self-belief and support can improve your finances. Parental health needs attention. Romance is in the air, so stay observant. You may finally land your desired work tasks, where your sharp focus will assist you in leading the pack. Your spouse will make you feel cherished. Although communication may feel stifled and patience worn thin, today offers a chance to boldly confront obstacles and assert your worth.",
    ...
    },
    {
        ...
        horoscope: "Optimism is your strength today. Financial success comes from listening to innovative advice. Engaging with parents brings mutual joy and alleviates loneliness. It's a delightful day, but reliance on others at work is ill-advised—focus on your own tasks and time management. Your spouse has a pleasant surprise in store. You'll feel free and creative, with the potential for a thrilling new romantic connection; however, remember that lasting commitment is built slowly.",
    ...
    },
    {
        ...
        horoscope: "Avoid alcohol to ensure restful sleep. Financial challenges may arise, so seek guidance from a father figure. Children will bring pride, but stay alert to workplace dynamics, including potential flirting or praise. Efficient time management is crucial, yet balancing family needs requires flexibility. You might see a surprisingly bold side of your spouse. Overall, energy levels are rising, fueling domestic improvements and financial resolutions—look out for alternative income streams beyond just a raise.",
    ...
    },
    {
        ...
        horoscope: "Cast aside gloom to make progress. Financial prospects look good for raising capital. A visit to an ailing relative is due. Your partner's love will feel deeply spiritual today. Business travel might occur but could induce stress, so avoid office politics. You may crave solitude amidst chaos, and fortunately, you'll find that personal time. Marital love blossoms beautifully. Unleash your creativity by experimenting with new styles; your innovative approach will surprise others and even yourself.",
